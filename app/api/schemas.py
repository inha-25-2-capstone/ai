...
class AnalyzeRequest(BaseModel):
    ...
    class Config:
        json_schema_extra = {"example": {"text": "정부의 새로운 정책이 발표되었습니다..."}}
...
class BatchAnalyzeRequest(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "articles": [{"article_id": 1, "text": "기사1 본문..."}, {"article_id": 2, "text": "기사2 본문..."}],
                "batch_size": 16,
            }
        }
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "stance_distribution": {"옹호": 5, "중립": 3, "비판": 2},
            }
        }
...
class HealthResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {"status": "healthy", "service": "AI News Stance Analysis", "timestamp": "2024-01-01T00:00:00"}
        }
...
class ErrorResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {"error": "Internal server error", "detail": "스탠스 분석 중 오류가 발생했습니다."}
        }
