...
def main():
    ...
    openai_output_file = base_dir / "data" / "batch_results" / "openai" / "batch_690f0cdf4e848190a8b4a242f2847c47_output.jsonl"
    merged_output_file = base_dir / "data" / "labeled" / "labeled_dataset.json"
    ...
    claude_labels = None
    claude_output_file = base_dir / "data" / "batch_results" / "claude" / "batch_claude_output.jsonl"
